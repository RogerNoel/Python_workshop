...
x.upper()
x.lower()
x.title()  # première lettre en majuscule
x.strip()  # enlève un caractère spécifié en début et fin de chaîne
x.find("p")
x.replace("a", "b")
"a" in x
...
# attention à l'indentation, elle est très importante, elle permet de marquer le début et la fin des blocs, elle fait office de délimliteur
if x == 1:
    print("a")
elif x == 2:
    print("b")
...
def save_user(**user):  # the ** allows key and values
    print(user)
